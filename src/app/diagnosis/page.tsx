...
const MBTI_TABLE: Record<string, MBTIEntry> = {
  ISTJ: {
    title: "체계적인 정보·리뷰형",
    categories: "제품 리뷰, 비교 분석, 재테크, 공부법, 업무 생산성, 자기계발",
  ...
  ISFJ: {
    title: "친절한 생활정보·루틴형",
    categories: "살림, 브이로그, 루틴, 다이어리, 요리, 생활 꿀팁, 공부 브이로그",
  ...
  INFJ: {
    ...
    categories: "심리, 인간관계, 에세이, 자기이해, 감성 브이로그, 독서",
  ...
  INTJ: {
    title: "전략형 지식·분석 채널",
    categories: "비즈니스, 트렌드 분석, 경제, 기술, AI, 전략, 커리어",
  ...
  ISTP: {
    title: "실전형 체험·테스트 채널",
    categories: "기기 리뷰, 자동차, 캠핑, 운동, 장비 테스트, DIY, 실험 콘텐츠",
  ...
  ISFP: {
    ...
    categories: "일상 브이로그, 패션, 뷰티, 카페, 여행, 음악, 감성 소품",
  ...
  INFP: {
    title: "스토리텔링·취향 세계관형",
    categories: "에세이, 창작, 독서, 영화 리뷰, 음악 추천, 감성 콘텐츠, 자기탐색",
  ...
  INTP: {
    title: "지적 탐구·해설형",
    categories: "과학, 철학, 역사, IT, AI, 게임 분석, 지식 해설",
  ...
  ESTP: {
    title: "액션·도전·리액션형",
    categories: "챌린지, 먹방, 여행, 스포츠, 거리 인터뷰, 체험 콘텐츠",
  ...
  ESFP: {
    ...
    categories: "브이로그, 뷰티, 패션, 먹방, 리액션, 쇼츠, 일상 예능",
  ...
  ENFP: {
    title: "아이디어·소통·트렌드형",
    categories: "트렌드 리뷰, 토크, 인터뷰, 여행, 자기계발, 관계 이야기",
  ...
  ENTP: {
    title: "논쟁·실험·기획형",
    categories: "토론, 사회 이슈, 실험 콘텐츠, 창업, 밈 분석, 트렌드 비평",
  ...
  ESTJ: {
    ...
    categories: "커리어, 업무법, 재테크, 부동산, 창업, 자기관리, 공부법",
  ...
  ESFJ: {
    title: "관계·생활·공감형 채널",
    categories: "연애, 인간관계, 가족, 일상 브이로그, 요리, 상담형 콘텐츠",
  ...
  ENFJ: {
    ...
    categories: "자기계발, 동기부여, 인간관계, 리더십, 커리어, 강연형 콘텐츠",
  ...
  ENTJ: {
    title: "비즈니스·전략·리더십형",
    categories: "창업, 비즈니스, 투자, 생산성, 리더십, 트렌드 분석",
